...
exports.creds = {
  ...
  // feature.
  identityMetadata: 'https://hibestowaeb2c.b2clogin.com/hibestowaeb2c.onmicrosoft.com/b2c_1a_signup_signin/v2.0/.well-known/openid-configuration', 
  // or equivalently: 'https://login.microsoftonline.com/<tenant_guid>/v2.0/.well-known/openid-configuration'

  // Required, the client ID of your app in AAD  
  clientID: 'dc20e876-fd3b-4b4d-aa37-1a2e9ee95ffc',
  ...
  clientSecret: '9O0v-WRREFI.49cKY.iqAT~n41JHzK~dkV', 
...
exports.destroySessionUrl = 
  'https://login.microsoftonline.com/hibestowaeb2c.onmicrosoft.com/oauth2/v2.0/logout' +
  '?p=<b2c_1a_SignUpOrSignInWithPhoneOrEmail>' +
